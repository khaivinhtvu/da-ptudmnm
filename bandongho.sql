...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 05, 2024 lúc 07:53 AM
...
INSERT INTO `sanpham` (`masp`, `tensp`, `hinh`, `gia`, `mota`, `gia_km`) VALUES
('02', 'Đồng hồ 22', 'images/dh2.jpg', 300000, 'đồng hồ treo tường', 250000),
('03', 'Đồng hồ 3', 'images/dh3.jpg', 300000, 'Đồng hồ treo tường', 250000),
('05', 'Đồng Hồ Đeo Tay B2', 'images/dh5.jpg', 700000, 'Đồng hồ đeo tay xanh lục', 650000),
('06', 'Đồng Hồ Đeo Tay C3', 'images/dh6.jpg', 770000, 'Đồng hồ đeo tay cổ điển', 700000);
...
('16850', 'abc', '827ccb0eea8a706c4c34a16891f84e7b', 'Nguyễn A', 'AB@gmail.com', 'Bến Tre', '0123456789'),
...
ALTER TABLE `giohang`
  ADD PRIMARY KEY (`id`),
  ADD KEY `rang_buot_san_pham` (`sanpham`);
...
--
ALTER TABLE `chitietgio`
  ADD CONSTRAINT `rang_buot_id_gio` FOREIGN KEY (`id`) REFERENCES `giohang` (`id`);

--
-- Các ràng buộc cho bảng `giohang`
--
ALTER TABLE `giohang`
  ADD CONSTRAINT `rang_buot_san_pham` FOREIGN KEY (`sanpham`) REFERENCES `sanpham` (`masp`);
COMMIT;
